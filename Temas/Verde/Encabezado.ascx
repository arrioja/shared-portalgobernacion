<%@ Control Language="c#" AutoEventWireup="false" Codebehind="Encabezado.ascx.cs" Inherits="Portal.Temas.Verde.Encabezado" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
		...
		<tr class="OtrasPags" vAlign="bottom" align="left">
			<td vAlign="bottom" align="left">
				<asp:datalist id="Paginas" runat="server" RepeatDirection="Horizontal" Height="30px" CellPadding="0"
					...
					<SelectedItemStyle BorderWidth="1px" BorderColor="AliceBlue" CssClass="SeleccionPag" VerticalAlign="Middle"></SelectedItemStyle>
					...
					<ItemStyle BorderWidth="1px" BorderColor="DarkBlue" CssClass="OtrasPags" VerticalAlign="Middle"></ItemStyle>
					<ItemTemplate>
