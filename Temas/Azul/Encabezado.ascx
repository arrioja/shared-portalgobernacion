<%@ Control Language="c#" AutoEventWireup="false" Codebehind="Encabezado.ascx.cs" Inherits="Portal.Temas.Azul.Encabezado" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
