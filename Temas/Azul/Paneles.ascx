<%@ Control Language="c#" AutoEventWireup="false" Codebehind="Paneles.ascx.cs" Inherits="Portal.Temas.Azul.Paneles" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
