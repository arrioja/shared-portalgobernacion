<%@ Control Language="c#" AutoEventWireup="false" Codebehind="Encabezado.ascx.cs" Inherits="Portal.Temas.Rojo.Encabezado" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
		...
		<tr class="OtrasPags" vAlign="bottom" align="left">
			<td vAlign="bottom" align="left">
				<asp:datalist id="Paginas" runat="server" RepeatDirection="Horizontal" Height="30px" CellPadding="0"
					...
					<ItemStyle BorderWidth="1px" BorderColor="Coral" CssClass="OtrasPags" VerticalAlign="Middle"></ItemStyle>
					<ItemTemplate>
