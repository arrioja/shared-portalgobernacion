<%@ Control Language="c#" AutoEventWireup="false" Codebehind="Paneles.ascx.cs" Inherits="PortalGobernacion.Temas.Pacheco.Paneles" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
