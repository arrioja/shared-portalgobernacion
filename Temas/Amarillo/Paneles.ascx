<%@ Control Language="c#" AutoEventWireup="false" Codebehind="Paneles.ascx.cs" Inherits="Portal.Temas.Amarillo.Paneles" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
