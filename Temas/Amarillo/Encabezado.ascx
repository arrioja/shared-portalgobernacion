<%@ Control Language="c#" AutoEventWireup="false" Codebehind="Encabezado.ascx.cs" Inherits="Portal.Temas.Amarillo.Encabezado" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
		...
		<tr class="OtrasPags" vAlign="bottom" align="left">
			<td vAlign="bottom" align="left">
				<asp:datalist id="Paginas" runat="server" RepeatDirection="Horizontal" Height="30px" CellPadding="0"
					...
					<SelectedItemStyle BorderWidth="1px" BorderColor="Ivory" CssClass="SeleccionPag" VerticalAlign="Middle"></SelectedItemStyle>
					...
					<ItemStyle BorderWidth="1px" BorderColor="Chocolate" CssClass="OtrasPags" VerticalAlign="Middle"></ItemStyle>
					<ItemTemplate>
