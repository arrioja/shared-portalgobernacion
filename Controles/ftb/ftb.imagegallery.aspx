...
// Messages
private string NoFileMessage = "No ha seleccionado ningun archivo";
private string UploadSuccessMessage = "Carga Exitosa";
private string NoImagesMessage = "No existen Imagenes";
private string NoFolderSpecifiedMessage = "No existe la carpeta";
private string NoFileToDeleteMessage = "No existen archivos para borrar";
private string InvalidFileTypeMessage = "Tipo de archivo invalido";
private string[] AcceptedFileTypes = new string[] {"jpg","jpeg","jpe","gif","bmp","png"};

// Configuration
private bool	UploadIsEnabled = false;
...
public void DeleteImage_OnClick(object sender, EventArgs e) {
	if (FileToDelete.Value != "" && FileToDelete.Value != "undefined") {
		try {
			...
			ResultsMessage.Text = "Borrado: " + FileToDelete.Value;
		} catch(Exception ex) {			
			ResultsMessage.Text = "Se presentaron errores.";
		}
	} else {
...
<tr><td height=16 style="padding-left:10px;border-top: 1 solid #999999; background-color:#99ccff;">
	...
	<tr>
		...
		<td valign=top><asp:button id="UploadImage" Text="Cargar" runat="server" onclick="UploadImage_OnClick" /></td>
		<td valign=top><asp:button id="DeleteImage" Text="Borrar" runat="server" onclick="DeleteImage_OnClick" /></td>
		<td valign=middle>		
	</tr>
	<tr>
		<td colspan=3>
